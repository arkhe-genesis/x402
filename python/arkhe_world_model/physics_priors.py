...
class PhysicsPriorsModule(nn.Module):
    ...
    def __init__(
        ...
        self.prior_dim = state_dim // n_priors
        self.actual_state_dim = self.prior_dim * n_priors
        ...
        self.prior_projections = nn.ModuleDict({
            "gravity": nn.Sequential(
                ...
                nn.ReLU(),
                nn.Linear(hidden_dim, self.prior_dim),
            ),
        ...
        self.output_proj = nn.Sequential(
            nn.Linear(self.actual_state_dim, state_dim),
    ...
    def forward(self, text_embedding: torch.Tensor) -> torch.Tensor:
        ...
        for i in range(self.n_priors):
            ...
            block = prior_stack[:, i*self.prior_dim:(i+1)*self.prior_dim]
